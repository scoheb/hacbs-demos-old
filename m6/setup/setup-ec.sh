DEVWORKSPACE=shebert
MANAGEDWORKSPACE=managed-shebert
...
oc policy add-role-to-user enterprisecontractpolicy-viewer-role -z m6-service-account -n $MANAGEDWORKSPACE
